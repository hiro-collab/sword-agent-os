...
function Test-ReadmeFirstRunGuidance {
  ...
  Assert-TextMatch -Text $projectionVisualStarter -Pattern "starter-profile:projection-visual-goal[\s\S]+starter-profile:projection-visual-route[\s\S]+starter-profile:projection-visual-result-fields[\s\S]+starter-profile:projection-visual-stop-conditions[\s\S]+starter-profile:projection-visual-does-not-prove" -Message "Projection Visual starter should follow the template section anchors"
