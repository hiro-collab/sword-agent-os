...
function Test-ReadmeFirstRunGuidance {
  ...
  Assert-TextMatch -Text $readme -Pattern "Voice / gesture / UI[\s\S]{0,240}Thought Core / control-plane[\s\S]{0,240}Home Control / Home Assistant" -Message "README at-a-glance diagram should show input, thought, and Home Control flow"
  Assert-TextMatch -Text $readme -Pattern "Avatar / Projection Visual / TTS[\s\S]{0,220}Proof layers / state checks" -Message "README at-a-glance diagram should show expression and proof layers"
